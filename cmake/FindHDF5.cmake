    ...
    if( HDF5_FOUND)
        ...
        foreach(_lang ${HDF5_LANGUAGE_BINDINGS})
            ...
            if( _lang_location )
                ...
                message(INFO "TRY ${_lang}")
                if("${_lang}" STREQUAL "Fortran")
                    message(INFO "TRY")
                    #get_target_property(_f90cstub_location ${HDF5_${f90cstub}_TARGET}${_suffix} LOCATION)
                    #if(_f90cstub_location)
                    #    list(APPEND HDF5_LIBRARIES ${_f90cstub_location})
                    #endif()
                endif()
